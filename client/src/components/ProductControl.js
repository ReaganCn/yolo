...
class ProductControl extends Component {
    ...
    componentDidMount(){
        axios.get('http://backend:5050/api/products')
            .then(res =>{
                console.log(res)
                this.setState({
    ...
    handleAddingNewProduct = (newProduct) =>{
        ...
        // }       
        // console.log(...formData)
        axios.post('http://backend:5050/api/products', newProduct)
    ...
    handleDeletingProduct = (id) =>{
        axios.delete('http://backend:5050/api/products/'+id)
            .then(res => console.log(res.data))
            .catch((error) =>{
                console.log(error)
            })
    ...
    handleEditingProduct = (editedProduct) =>{
        ...
        axios.put('http://backend:5050/api/products/' + this.state.selectedProduct._id, editedProduct)
            .then(res =>console.log(res.data))
